...
export type ClaveTermino =
  ...
  | 'TerminoCita'
  | 'TerminoHistorial'
  | 'TerminoDisponibilidad'
  // Acciones
  | 'AccionNuevaAsignacion'
  | 'AccionVerDisponibilidad'
  | 'AccionBuscarCliente'
  | 'AccionGestionarRecursos'
  | 'AccionGestionarServicios'
  // Pantallas
  | 'PantallaOperacionHoy'
  | 'PantallaCalendario'
  | 'PantallaDisponibilidad'
  | 'PantallaCatalogoServicios'
  | 'PantallaClientes'
  | 'PantallaRecursos'
  // Mensajes
  | 'MsgSeleccionarRecursos'
  | 'MsgSeleccionarReserva'
  | 'MsgProximaDisponibilidad'
  | 'MsgSinDatos'
  | 'MsgCargando'
  // Notificaciones
  | 'NotifAsuntoNuevaCita'
  | 'NotifCuerpoNuevaCita'
  | 'NotifAsuntoRecordatorio'
  | 'NotifCuerpoRecordatorio'
  | 'NotifAsuntoCancelacion'
  | 'NotifCuerpoCancelacion'
  | 'NotifAsuntoReprogramacion'
  | 'NotifCuerpoReprogramacion'
  // Teams
  | 'TeamsAsuntoEvento'
  | 'TeamsCuerpoEvento'
  | 'TeamsUbicacion'
  // PDFs
  | 'PdfTituloReporteCitas'
  | 'PdfTituloHistorial'
  | 'PdfColumnaCliente'
  | 'PdfColumnaRecurso'
  | 'PdfColumnaServicio'
  ...
  | 'TituloCancelarCita'
  | 'TituloCitaCancelada'
  | 'MsgCitaCanceladaExito'
  | 'MsgCancelacionRequiereMotivo'
  | 'MsgSeleccionarNuevaFecha'
  | 'MsgEscCerrar'
  | 'MsgEnterCerrar'
  | 'PlaceholderSeleccionarMotivo'
  | 'PlaceholderDescripcionCancelacion'
  | 'PlaceholderMotivoReprogramacion'
  // Profesionales
  | 'ProfesionalesSub'
  | 'PlaceholderBuscarNombre'
  | 'LabelEspecialidad'
  | 'LabelTodas'
  | 'LabelSede'
  | 'LabelSoloActivos'
  | 'BtnNuevoProfesional'
  | 'MsgProfesionalCreado'
  | 'MsgProfesionalActualizado'
  | 'MsgConfirmarInactivar'
  | 'MsgProfesionalInactivado'
  | 'MsgSinProfesionales'
  | 'ColConsultorio'
  | 'ColRegistroMedico'
  | 'BtnHorario'
  | 'MsgConteoProfesionales'
  | 'TituloNuevoProfesional'
  | 'TituloEditarProfesional'
  | 'ValEspecialidadRequerida'
  | 'ValSedeRequerida'
  | 'LabelNumeroIdentificacion'
  | 'LabelConsultorioSala'
  | 'PlaceholderConsultorio'
  | 'PlaceholderTarjetaProfesional'
  ...
  | 'MsgMinimoNombre'
  | 'MsgMinimoDocumento'
  | 'MsgConfirmarInactivarPaciente'
  | 'MsgPacienteInactivado'
  | 'MsgPacienteCreado'
  | 'MsgPacienteActualizado'
  | 'MsgSinPacientes'
  | 'ColIdentificacion'
  | 'ColNumero'
  | 'ColNombresCompletos'
  ...
  | 'BtnSiguiente'
  | 'MsgPaginaDe'
  | 'MsgPacientesEncontrados'
  | 'TituloNuevoPaciente'
  | 'TituloEditarPaciente'
  | 'LabelNombresCompletos'
  ...
  | 'MsgGuardando'
  | 'BtnCancelar'
  | 'ValidacionNombresObligatorios'
  | 'ValidacionDocumentoObligatorio'
  | 'ValidacionNacimientoObligatorio'
  | 'ValidacionSexoObligatorio'
  // Catálogos admin
  | 'CatalogoTitulo'
  | 'CatalogoSub'
  | 'CatalogoSeccion'
  | 'CatalogoCargando'
  | 'CatalogoSinCatalogos'
  | 'CatalogoAdministrar'
  | 'CatalogoAct'
  | 'CatalogoInac'
  | 'CatalogoBuscar'
  | 'CatalogoBuscarPlaceholder'
  | 'CatalogoTodos'
  | 'CatalogoSoloActivos'
  | 'CatalogoRegistros'
  | 'CatalogoNuevoRegistro'
  | 'CatalogoGuardar'
  | 'CatalogoGuardando'
  | 'CatalogoCancelar'
  | 'CatalogoNoRegistros'
  | 'CatalogoRequiereValidacion'
  | 'CatalogoEstado'
  | 'CatalogoActivo'
  | 'CatalogoInactivo'
  | 'CatalogoEditar'
  ...
  | 'CatalogoSiguiente'
  | 'CatalogoNoBorrar'
  | 'CatalogoEnUsoDesactivar'
  | 'CatalogoEnUsoNoBorrar'
  | 'CatalogoCerrar'
  | 'CatalogoDesactivarRegistro'
  | 'CatalogoBorrarDefinitivamente'
  | 'CatalogoRegistroEliminar'
  | 'CatalogoSeEliminara'
  | 'CatalogoSiBorrar'
  | 'CatalogoCompleteCampos'
  | 'CatalogoRegistroCreado'
  | 'CatalogoRegistroActualizado'
  | 'CatalogoRegistroDesactivado'
  | 'CatalogoRegistroActivado'
  | 'CatalogoRegistroBorrado'
  | 'CatalogoVolver'
  | 'CatalogoNuevo'
  | 'CatalogoSi'
  | 'CatalogoNo'
  | 'CatalogoOpcionPorDefecto'
  // Disponibilidad
  | 'DispSub'
  | 'BtnVolverProfesionales'
  | 'LabelProfesional'
  | 'BtnNuevaPlantilla'
  | 'MsgSinHorarios'
  | 'MsgSeleccionarProfHorarios'
  | 'ColDia'
  | 'ColDuracionTurno'
  | 'ColSede'
  | 'TxtMin'
  ...
  | 'ColFranja'
  | 'TxtDiaCompleto'
  | 'ConfirmInactivarHorario'
  | 'ConfirmInactivarBloqueo'
  | 'ConfirmInactivarExcepcion'
  | 'ExitoPlantillaCreada'
  | 'ExitoPlantillaActualizada'
  | 'ExitoHorarioInactivado'
  | 'ExitoBloqueoCreado'
  | 'ExitoBloqueoInactivado'
  | 'TitExcepcionesHorarias'
  | 'BtnNuevaExcepcion'
  | 'DispDescExcepciones'
  | 'MsgSinExcepciones'
  | 'ExitoExcepcionCreada'
  | 'ExitoExcepcionInactivada'
  | 'TitEditarHorario'
  | 'TitNuevoHorario'
  | 'LabelDiaSemana'
  | 'LabelHoraInicio'
  ...
  | 'ValFechasRequeridas'
  | 'ValFechaFinAnterior'
  | 'ValHorasFranjaRequeridas'
  | 'BtnGuardarBloqueo'
  | 'TitNuevaExcepcionHoraria'
  | 'LabelFecha'
  | 'ValFechaRequerida'
  | 'BtnGuardarExcepcion'
  | 'TxtPlantillaSingular'
  | 'TxtPlantillaPlural'
  | 'TxtBloqueoSingular'
  | 'TxtBloqueoPlural'
  | 'TxtExcepcionSingular'
  | 'TxtExcepcionPlural'

export interface CatalogoTerminoDto {
  id: number
  tenantId: number
  clave: ClaveTermino
  valor: string
...
export interface CrearTerminoRequest {
  clave: ClaveTermino
  valor: string
  categoria: string
  vertical: string
...
export interface ActualizarTerminoRequest {
  valor: string
  categoria: string
}

export interface SeedCatalogoRequest {
  vertical: string
}