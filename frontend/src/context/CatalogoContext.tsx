...
const NUM_A_CLAVE: Record<number, ClaveTermino> = {
  ...
  47: 'MsgSeleccionarProfesional', 48: 'NuevaCitaSub', 49: 'MsgSeleccionarCliente',
...
const DEFAULT_VALUES: Record<ClaveTermino, string> = {
  ...
  NuevaCitaSub: 'Registre una cita para un paciente existente. La duración depende del tipo de cita.',
  MsgSeleccionarCliente: 'Seleccione el cliente de la lista antes de continuar.',
